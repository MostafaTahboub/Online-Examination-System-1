...
export class CreateAdmin1698221813286 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        let adminPermission = await queryRunner.query(
            `INSERT INTO Permission (name) VALUES("admin")`
          );
          let adminRole = await queryRunner.query(
            `INSERT INTO Role (roleName, permissions) VALUES ("admin", [${adminPermission}])`
          );
          let user =
            await queryRunner.query(`INSERT INTO User (username, name, password, role) 
              VALUES ("root", "root","123456789", ${adminRole})`);
          await queryRunner.query(`INSERT INTO Role (roleName) VALUES ("student")`);
          await queryRunner.query(
            `INSERT INTO Role (roleName) VALUES ("instructor")`
          );
    }
